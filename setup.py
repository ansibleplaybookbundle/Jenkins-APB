...
class OpenShiftAnsibleGenerateConfiguration(Command):
    description = "Create ansible.cfg"
    user_options = []
    def initialize_options(self):
        ''' initialize_options '''
        pass
    ...
    def run(self):
        ...
        lines = "[defaults]\n", "retry_files_enabled = False\n", "roles_path = /etc/ansible/roles:roles/:/tmp/roles/\n"
        with open(ansible_cfg, 'w') as cfg:
...
setup(
    ...
    cmdclass={
        ...
        'generate_configuration': OpenShiftAnsibleGenerateConfiguration
    },
    packages=[],
)
